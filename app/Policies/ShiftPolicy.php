...
class ShiftPolicy
{
    ...
    public function viewAll(Account $user) {
        return $this->getPermissions($user, 'Shift-index');
    }

    public function create(Account $user) {
        return $this->getPermissions($user, 'Shift-create');
    }

    public function update(Account $user) {
        return $this->getPermissions($user, 'Shift-update');
    }
    
    public function delete(Account $user) {
        return $this->getPermissions($user, 'Shift-delete');
    }
