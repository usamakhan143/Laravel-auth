...
class AttendanceController extends Controller
{
    ...
    public function markAttendance() {
        ...
        $getCurrentMac = Helper::getCurrentMac();
        $officeNet = Cnetwork::all()->pluck('mac')->toArray();
        $checkIP = in_array($getCurrentMac, $officeNet);
    ...
    public function checkInStore() {
        ...
        $currentNetwork_Address = Helper::getCurrentMac();
        $officeStatus = Cnetwork::where('name', 'Office')->value('status');
