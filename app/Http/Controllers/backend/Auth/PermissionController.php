...
class PermissionController extends Controller
{
    ...
    public function storePermission(Request $request) {
        ...
        if(Auth::user()->can('permissions.create')) {
            ...
            if ($p_for == 'dashboard-panel' || $p_for == 'other_post-type' || $p_for == 'users_post-type' || $p_for == 'permissions_post-type' || $p_for == 'roles_post-type' || $p_for == 'shifts_post-type')
            {
    ...
    public function updatePermission(Request $request, $id) {
        ...
        if(Auth::user()->can('permissions.update')) {
            ...
            {
                if ($p_for == 'dashboard-panel' || $p_for == 'other_post-type' || $p_for == 'posttype_post-type' || $p_for == 'users_post-type' || $p_for == 'permissions_post-type' || $p_for == 'roles_post-type' || $p_for == 'shifts_post-type')
                {
            ...
            {
                if ($p_for == 'dashboard-panel' || $p_for == 'other_post-type' || $p_for == 'slots_post-type' || $p_for == 'users_post-type' || $p_for == 'permissions_post-type' || $p_for == 'roles_post-type' || $p_for == 'shifts_post-type')
                {
                    $peredit->name = $request->name;
                    $peredit->for = $p_for;
