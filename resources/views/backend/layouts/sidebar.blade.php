        ...
        <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                      @can('reports.generate', Auth::user())
                        <li><a href="{{ route('report.create') }}"><i class="fa fa-genderless"></i>Generate Report</a></li>
                      @endcan
                      @can('reports.thismonth', Auth::user())
                      <li><a href="{{ route('report.allatt') }}"><i class="fa fa-genderless"></i>All {{ date('M') }}
                                Attendance</a></li>
                      @endcan
                    </ul>
                </li>
            ...
            @can('permissions.view', Auth::user())
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        @can('permissions.view', Auth::user())
                            <li><a href="{{ route('permissions.index') }}"><i class="fa fa-genderless"></i>All Permissions</a>
                            </li>
                        @endcan
                        @can('permissions.create', Auth::user())
                            <li><a href="{{ route('permissions.create') }}"><i class="fa fa-genderless"></i>Add Permission</a>
                            </li>
                        @endcan
                    </ul>
                </li>
