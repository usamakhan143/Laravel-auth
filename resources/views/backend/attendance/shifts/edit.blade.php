	...
	<div class="col-md-6">
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Edit a Shift</h3>
        ...
        <div class="box-body">
          ...
          <div class="row">
            <div class="col">
            	<form action="{{ route('shift.update', $findShift->id) }}" method="post">
            		@csrf
                    @method('PUT')
					<div class="form-group">
						<h5>Shift Name <span class="text-danger">*</span></h5>
						<div class="controls">
							<input type="text" name="name" class="form-control" placeholder="Enter Shift Name" value="{{ $findShift->name }}" /> 
						</div>
						@error('name')
						    <p class="validate">
						      {{ $message }}
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="controls">
                                    <input type="time" name="start_time" class="form-control" placeholder="Enter Start Time" value="{{ $findShift->start_time }}" /> 
                                </div>
                                @error('start_time')
                                    <p class="validate">
                                    {{ $message }}
                            ...
                            <div class="col">
                                ...
                                <div class="controls">
                                    <input type="time" name="end_time" class="form-control" placeholder="Enter End Time" value="{{ $findShift->end_time }}" /> 
                                </div>
                                @error('end_time')
                                    <p class="validate">
                                    {{ $message }}
                            ...
                            <div class="controls">
                                <fieldset>
                                    <label class="custom-control custom-checkbox">
                                        <input type="checkbox" value="1" name="status" class="custom-control-input" <?php if ($findShift->status == 1): ?>
														<?php echo 'checked' ?>
					...
					<div class="text-xs-right">
						<button type="submit" class="btn btn-info">Edit shift</button>
					</div>
				</form>
